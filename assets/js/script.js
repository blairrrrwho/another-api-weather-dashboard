   ...
   // Load searched cities from local storage
    ...
    if (citiesSearchedObjectsArray) {
        citiesSearchedObjectsArray.forEach(function (object) {
            ...
            newSearchedCity.getAttribute("type", "submit");
            // newSearchedCity.getAttribute("searchedCity", object.city);
            newSearchedCity.innerHTML = object.city;
            searchList.append(newSearchedCity);
        });
        getWeather(
